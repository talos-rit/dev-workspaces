    ...
    namespace icd
    {
        namespace server
        {
            ...
            struct Task
            {
                ...
                std::shared_ptr<std::promise<void>> completion; // optional completion signal
            };
            ...
            public:
                ...
                explicit TalosOperatorService(std::shared_ptr<TaskQueue> queue);
            ...
            private:
                ...
                // Helper to enqueue a task and wait until completion
                void enqueue_task(const std::string &task_name, std::function<void()> work);
                void enqueue_and_wait(const std::string &task_name, std::function<void()> work) { enqueue_task(task_name, std::move(work)); }
            };
